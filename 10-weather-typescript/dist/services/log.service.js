...
export class LogService {
    ...
    static showWeatherData(data, language) {
        switch (language) {
            case LANGUAGE.RUSSIAN:
                console.log(dedent `${chalk.bgYellow(' WEATHER ')} Погода в городе ${data.name}
            ...
            case LANGUAGE.ENGLISH:
                console.log(dedent `${chalk.bgYellow(' WEATHER ')} Weather in ${data.name}
                    ${data.weather[0].description}
